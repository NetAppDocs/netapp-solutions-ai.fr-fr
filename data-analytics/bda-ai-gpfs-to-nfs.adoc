...
summary: 'Cette section fournit les étapes détaillées nécessaires pour configurer GPFS et déplacer des données vers NFS à l"aide de NetApp XCP.' 
---
...
[role="lead"]
Cette section fournit les étapes détaillées nécessaires pour configurer GPFS et déplacer des données vers NFS à l'aide de NetApp XCP.



== Configurer GPFS

. Téléchargez et installez Spectrum Scale Data Access pour Linux sur l’un des serveurs.
+
....
...
…
....
. Installez le package prérequis (y compris chef et les en-têtes du noyau) sur tous les nœuds.
+
....
...
....
. Désactiver SELinux dans tous les nœuds.
+
....
...
[root@mastr-51 5.0.3.1]#
....
. Configurer le nœud d’installation.
+
....
...
[root@mastr-51 installer]#
....
. Ajoutez le nœud d’administration et le nœud GPFS au fichier de définition du cluster.
+
....
...
[root@mastr-51 installer]#
....
. Ajoutez le nœud gestionnaire et le nœud GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Ajoutez le nœud quorum et le nœud GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Ajoutez les serveurs NSD et le nœud GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Ajoutez les nœuds GUI, admin et GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Vérifiez et répertoriez tous les nœuds.
+
....
...
[root@mastr-51 installer]#
....
. Spécifiez un nom de cluster dans le fichier de définition de cluster.
+
....
...
....
. Spécifiez le binaire du shell distant à utiliser par GPFS ; utilisez `-r argument` .
+
....
...
[root@mastr-51 installer]#
....
. Spécifiez le binaire de copie de fichier distant à utiliser par GPFS ; utilisez `-rc argument` .
+
....
...
[root@mastr-51 installer]#
....
. Spécifiez la plage de ports à définir sur tous les nœuds GPFS ; utilisez `-e argument` .
+
....
...
[root@mastr-51 installer]#
....
. Afficher les paramètres de configuration GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Ajouter un nœud d'administration.
+
....
...
[root@mastr-51 installer]#
....
. Pré-vérifiez les configurations avant l'installation.
+
....
...
Pour exporter GPFS vers NFS, procédez comme suit :
...
. Installer les packages dans le client NFS.
+
....
...
[root@hdp2 gpfstest]#
....
. Déplacez les données du NFS exporté GPFS vers le NFS NetApp à l'aide de XCP.
+
....
